...
import { dispatchSupervisorPhase, getWorkspace } from './index';
import { createProjectFixture, initHome } from '../../../tests/helpers/runtime';

describe('dispatchSupervisorPhase', () => {
  ...
  test('creates a run in executing state', () => {
    ...
    const dispatched: any = dispatchSupervisorPhase(feature, 'implementation', home);
