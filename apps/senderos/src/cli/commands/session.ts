...
const sessionShowHelp = {
  ...
  agentDescription:
    'Use this to inspect one persisted session record by id, including its status snapshot and resume metadata.',
...
const sessionResumeHelp = {
  ...
  agentDescription:
    'Use this only when you already know a session exists and need the persisted resume metadata that SenderOS recorded for it.',
