...
The CLI is the public interface. Under it lives Senderos' own operating logic: internal agents, deterministic services, persisted senderos, planning, dispatch, and recorded execution state.
