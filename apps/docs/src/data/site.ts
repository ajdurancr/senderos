...
export const NAVIGATION: { section: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      {
        slug: 'core/how-senderos-works',
        title: 'How Senderos Works',
        section: 'Operating model',
      },
      {
        slug: 'core/reconciliation-and-dispatch',
  ...
  },
  {
    ...
    items: [
      {
        slug: 'agents/skills-and-harnesses',
  ...
  },
  {
    ...
    items: [
      {
        slug: 'automation/worker-and-scheduling',
        title: 'Planning, Dispatch, and Scheduling',
        section: 'Automation',
      },
    ],
  },
  {
    ...
    items: [
      {
        slug: 'operations/persistence-and-state',
        title: 'Persistence and State',
        section: 'Operations',
      },
      {
        slug: 'operations/working-paths-and-guardrails',
        title: 'Working Paths and Guardrails',
        section: 'Operations',
      },
      {
        slug: 'operations/safety-and-confirmations',
  ...
  },
  {
    ...
    items: [
      {
        slug: 'contributing/engineering-guide',
...
export function getNeighbors(slug: string) {
  ...
  return {
    ...
    next:
      index >= 0 && index < FLAT_NAV.length - 1 ? FLAT_NAV[index + 1] : null,
  };
}
